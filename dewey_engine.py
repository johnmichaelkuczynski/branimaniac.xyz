...
class DeweyInferenceEngine:
    def __init__(self, rules_file='dewey_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Dewey inference engine loaded: {len(self.rules):,} rules")
