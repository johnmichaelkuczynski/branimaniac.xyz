...
class ConfuciusInferenceEngine:
    def __init__(self, rules_file='confucius_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Confucius inference engine loaded: {len(self.rules):,} rules")
...
def get_engine():
    global engine
    if engine is None:
        engine = ConfuciusInferenceEngine()
    return engine
