...
class BaconInferenceEngine:
    def __init__(self, rules_file='bacon_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Bacon inference engine loaded: {len(self.rules):,} rules")
