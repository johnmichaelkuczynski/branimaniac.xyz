...
class SartreInferenceEngine:
    def __init__(self, rules_file='sartre_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Sartre inference engine loaded: {len(self.rules):,} rules")
