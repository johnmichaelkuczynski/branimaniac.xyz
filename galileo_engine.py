...
class GalileoInferenceEngine:
    def __init__(self, rules_file='galileo_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Galileo inference engine loaded: {len(self.rules):,} rules")
