...
async function embedDarwinCorpus() {
  console.log("Starting Charles Darwin Works embedding...\n");
  
  const files = [
    {
      path: path.join(process.cwd(), 'attached_assets', 'DARWIN_AUTOBIOGRAPHY_1765863388098.txt'),
  ...
  console.log(`\n========================================`);
  console.log(`DARWIN CORPUS EMBEDDING COMPLETE`);
  console.log(`========================================`);
...
embedDarwinCorpus().catch(console.error);
