...
async function embedDeweyCorpus() {
  console.log("Starting John Dewey Complete Works embedding...\n");
  
  const files = [
    {
      path: path.join(process.cwd(), 'attached_assets', 'The_Collected_Works_of_John_Dewey__The_Complete_Works_Pergamon_1765862407143.txt'),
      title: "The Collected Works of John Dewey"
    }
  ];
  ...
  console.log(`\n========================================`);
  console.log(`DEWEY CORPUS EMBEDDING COMPLETE`);
  console.log(`========================================`);
