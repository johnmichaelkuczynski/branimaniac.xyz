...
class EngelsInferenceEngine:
    def __init__(self, rules_file='engels_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Engels inference engine loaded: {len(self.rules):,} rules")
