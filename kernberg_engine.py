...
class KernbergInferenceEngine:
    def __init__(self, rules_file='kernberg_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Kernberg inference engine loaded: {len(self.rules):,} rules")
...
def get_engine():
    global engine
    if engine is None:
        engine = KernbergInferenceEngine()
    return engine
