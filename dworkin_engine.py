...
class DworkinInferenceEngine:
    def __init__(self, rules_file='dworkin_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Dworkin inference engine loaded: {len(self.rules):,} rules")
