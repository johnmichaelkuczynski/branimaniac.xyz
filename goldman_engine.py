...
class GoldmanInferenceEngine:
    def __init__(self, rules_file='goldman_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Goldman inference engine loaded: {len(self.rules):,} rules")
