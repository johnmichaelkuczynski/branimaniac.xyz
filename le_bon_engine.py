...
class Le_bonInferenceEngine:
    def __init__(self, rules_file='le_bon_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Le_bon inference engine loaded: {len(self.rules):,} rules")
