...
class AesopInferenceEngine:
    def __init__(self, rules_file='aesop_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Aesop inference engine loaded: {len(self.rules):,} rules")
