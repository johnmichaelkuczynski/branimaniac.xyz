...
class AdlerInferenceEngine:
    def __init__(self, rules_file='adler_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Adler inference engine loaded: {len(self.rules):,} rules")
