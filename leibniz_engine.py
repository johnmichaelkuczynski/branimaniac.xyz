...
class LeibnizInferenceEngine:
    def __init__(self, rules_file='leibniz_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Leibniz inference engine loaded: {len(self.rules):,} rules")
