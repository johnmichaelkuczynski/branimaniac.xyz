...
class BerkeleyInferenceEngine:
    def __init__(self, rules_file='berkeley_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Berkeley inference engine loaded: {len(self.rules):,} rules")
...
def get_engine():
    global engine
    if engine is None:
        engine = BerkeleyInferenceEngine()
    return engine
