...
class SpencerInferenceEngine:
    def __init__(self, rules_file='spencer_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Spencer inference engine loaded: {len(self.rules):,} rules")
