...
class DescartesInferenceEngine:
    def __init__(self, rules_file='descartes_rules_full.json'):
    ...
    def _ensure_loaded(self):
        ...
        try:
            ...
            print(f"Descartes inference engine loaded: {len(self.rules):,} rules")
...
def get_engine():
    global engine
    if engine is None:
        engine = DescartesInferenceEngine()
    return engine
